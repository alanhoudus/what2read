    ...
    <div className="readings-books">
      <div className="readings-book">
        <a href="#">
          ...
          <img className="search-img" src="https://products-images.di-static.com/image/suzanne-collins-hunger-games-tome-1/9782266260770-475x500-1.webp" alt="title" /><Star className="readings favorited" color="#ffff00" /> <FileText className="readings review-done" color="#32CD32" />
        </a>
      </div>
      <div className="readings-book">
        <a href="#">
          ...
          <img className="search-img" src="https://products-images.di-static.com/image/suzanne-collins-hunger-games-tome-2-l-embrasement/9782266260787-475x500-1.webp" alt="title" /><Star className="readings not-favorited" color="#000" /> <FileText className="readings review-undone" color="#ff0000" />
        </a>
      </div>
      <div className="readings-book">
        <a href="#">
